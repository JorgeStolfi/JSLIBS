#ifndef nmsim_cohort_mf_state_H
#define nmsim_cohort_mf_state_H
 
/* Mean-field state and evolution of a neuron cohort. */
/* Last edited on 2018-03-24 04:50:49 by jstolfi */
...
void nmsim_cohort_mf_state_set
  ...
  /* Sets the state parameters of a cohort {cs} to potential {V_avg ±
    V_dev}, leakage modulator {L}, input modulator {G}, output modulator {H}, and relative
    fraction {eta}.
