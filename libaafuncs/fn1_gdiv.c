/* See {fn1_gdiv.h}. */
/* Last edited on 2016-12-26 21:34:12 by stolfilocal */
...
Float fn1_gdiv_eval_fp (Float x)
  {
    ROUND_NEAR;
    return (Float)(sqrt(x*x+Four*Four)/sqrt(x*x+One));
  }
...
Float fn1_gdiv_epsilon = 1.0e-6f;
Float fn1_gdiv_delta = 1.0e-20f;
