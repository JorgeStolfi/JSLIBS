...
Float fn1_f4_eval_fp (Float x)
  { ROUND_NEAR;
    { Float xa = (Float)((x + 2.0)*(x + 2.0) + Fudge);
      Float xb = (Float)((x + 1.0)*(x + 1.0) + Fudge);
      Float xc = (Float)((x - 1.0)*(x - 1.0) + Fudge);
      Float xd = (Float)((x - 2.0)*(x - 2.0) + Fudge);
...
Float fn1_f4_epsilon = 5.0e-7f;
Float fn1_f4_delta = 1.0e-20f;
int fn1_f4_nsub = 16;
