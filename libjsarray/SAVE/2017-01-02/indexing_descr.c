...
/* Last edited on 2017-01-02 21:41:49 by jstolfi */
...
ix_descr_t ix_descr_from_sizes ( ix_dim_t na, const ix_size_t sz[], ix_order_t ixor )
  { ix_descr_t D;
    D.na = na;
    ix_sizes_assign(na, D.sz, sz);
    ix_packed_steps(na, D.sz, ixor, D.st);
    D.bp = 0;
    return D;
  }
