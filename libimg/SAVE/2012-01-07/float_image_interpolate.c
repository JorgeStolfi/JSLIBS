...
/* Last edited on 2012-01-06 23:47:20 by stolfilocal */ 
...
void float_image_interpolate_get_indices_and_weights
  ...
  /* Computes the indices {i[0..m-1]} of the {m} pixels needed to
    ...
    coordinate {t}, and their respective weights {w[0..m-1]}. Indices {i}
...
void float_image_interpolate_get_indices_and_weights
  ...
  )
  {
    ...
    /* Adjust {t} to be relative to start of first pixel: */
    t = t - 0.5*(m - 1);
