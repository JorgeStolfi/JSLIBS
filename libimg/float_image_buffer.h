...
/* Last edited on 2024-12-04 23:42:40 by stolfi */
...
typedef struct float_image_buffer_t
  { int32_t sz[3];          /* Number of image. */
    int32_t NB;             /* Number of rows in buffer. */
    int32_t yini;           /* Index of first image row currently in buffer. */
    int32_t ylim;           /* Index of first image row after those in buffer. */
