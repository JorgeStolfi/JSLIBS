...
/* Last edited on 2009-07-11 14:34:02 by stolfi */
...
void fimm_est_avg_var(int ni, double v[], double m[], int k, int dk, double *Mp, double *Vp, double *Wp);
...
double float_image_mismatch_var
  ...
  { 
    int nwx = 2*hwx+1;
    int nwy = 2*hwy+1;
    int nw = nwx*nwy; /* Number of samples in window grid. */
...
void fimm_est_avg_var(int ni, double v[], double m[], int k, int dk, double *Mp, double *V2p, double *Wp)
  {
    /* Compute the weight : */
