...
/* Last edited on 2020-12-07 00:44:47 by jstolfi */
...
nmsim_elem_neuron_trace_t *nmsim_elem_neuron_trace_new
  ...
  /* Allocates a new {nmsim_elem_neuron_trace_t} record on the heap
    with space for states at times {tlo..thi}.  All entries are cleared with 
...
/* TRACE SAVING PROCEDURES 
  ...
  neuron trace {trne}, if it exists -- that is, {trne->ts[t - trne.tlo]},
  if {t} is in {trne.tlo .. trne.thi} */
...
#define nmsim_elem_neuron_trace_VERSION "2019-03-22"
