...
EXCEPTION
  ...
  BadChars(TEXT);    (* CHARS is untranslatable to String (arg tells why). *)
  BadString(TEXT);   (* String is untranslatable to CHARS (arg tells why). *)
...
TYPE
  T = OBJECT METHODS
      ...
      (*
        ...
        Will automatically reallocate "c" if it is NIL or too short. *)

      StringToText(READONLY w: String): TEXT RAISES {BadString};
      (*
        Converts a String "w" to a TEXT.  Equivalent to 
