...
UNSAFE MODULE ExhibVerif EXPORTS Main;       (* Version 2.8 -- 23/Oct/92 *)
...
6.nov.92 (tk):     Specila version for exhibition -- time protected
...
*)
  ...
  CONST
    ...
    Version = "versão de demonstração (7/nov/92)";
    
    ExpireDateTime = Util.UtilDateTime{year:=1992,month:=10,day:=15,
...
(* ---------------------------------------------------------------------- *)
  ...
  BEGIN
      TRY
        ...
        ELSIF Util.CompareLess(ExpireDateTime,Util.ExtractDateTime()) THEN
