...
/* Last edited on 2008-04-19 15:29:18 by stolfi */ 
...
msm_cand_vec_t msm_multi_find_matches
  ...
  /* Finds good pairings between two sequences {a[0]} and {b[0]} by
    ...
    with largest scores, among those that span at least {minCover} 
    ...
    discarding those that cover less than {minCover} positions
    on either sequence, at the finest scale.
