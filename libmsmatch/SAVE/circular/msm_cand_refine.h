...
/* Last edited on 2008-04-19 15:38:39 by stolfi */
...
msm_cand_t msm_cand_refine
  ...
  /* Finds a pairing with maximum score between two sequences {ap} and
    ...
    If {shrink} is FALSE, the range of {R}-ccordinates will not be
    ...
    If both {expand} and {shrink} are TRUE, therefor, the refined candidate
