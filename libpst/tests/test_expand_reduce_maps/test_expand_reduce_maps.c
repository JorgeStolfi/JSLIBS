...
/* Last edited on 2020-10-11 03:48:25 by jstolfi */
...
typedef struct options_t
  { int function;  /* Number of function to use. */
  } options_t;
...
void test_r_e_slope_map(int nfunc);
...
void make_maps(int NX, int NY, zfunc_t func, double maxGDiff, float_image_t **ZP, float_image_t **GP, float_image_t **WP);
...
void test_r_e_height_map(int nfunc);
...
void test_r_e_slope_map(int nfunc)
  {
    ...
    /* Choose size: */
    int NX_I = int32_abrandom(10, 20);
    int NY_I = int32_abrandom(10, 20);
    /* Choose the function: */
...
void compare_and_write_slope_maps
  ...
  )  
  {
    ...
    int NX_I = (int)IG->sz[1];
    int NY_I = (int)IG->sz[2];
    
    /* Dimensions of reduced reference map: */
    int NX_K = (int)KG->sz[1];
    int NY_K = (int)KG->sz[2];
