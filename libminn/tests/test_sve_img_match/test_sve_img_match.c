...
/* Last edited on 2017-03-16 18:26:22 by stolfilocal */
      ...
      { /* Optimize iteratively: */
        ...
        if (plot_goal)
          { /* Plot goal function: */
            ...
            minn_plot_1D_gnuplot(wr, nx, F, xx, NSteps, Rad);
            fclose(wr);
            free(fname);
          }

        sve_minn_iterate(nx, &F, &OK, xx, &Fx, dir, dMax, dBox, rIni, rMin, rMax, stop, maxIters, debugMinn);
        fprintf(stderr, "\n");
      }
