/* See {zf.h} */
/* Last edited on 2016-04-01 01:18:03 by stolfilocal */
...
Float zf_compute_max_root_hi (Float xlo, Float epsilon, Float delta);
...
Float zf_compute_max_root_hi (Float lo, Float epsilon, Float delta)
  { Float hi;
...
double log2 (double x)
  { return (1.4426950408889634074L * log(x)); }
