...
/* Last edited on 2024-08-30 11:40:15 by stolfi */ 
...
hr2_pmap_t hr2_pmap_from_four_r2_points(r2_t *p, r2_t *q, r2_t *r, r2_t *u);
  /* Returns a projective map that takes the Cartesian points {(0,0)},
    {(1,0)}, and {(0,1)} to the points {p}, {q}, and {r}, respectively;
    and also some point {s} to the point {u}.
