...
/* Last edited on 2024-11-20 12:39:54 by stolfi */ 
...
typedef double opf_arc_cost_t(uint32_t u, uint32_t v);
  /* Type of a function that returns the cost of an arc between vertices
    {u} and {v} of a graph. The result must be non-negative and not
    {NAN}. If there is no such arc, it should return {+INF}. */
