...
hr2_pmap_t hr2_pmap_from_mat_and_disp(r2x2_t *mat, r2_t *disp)
  {
    ...
    m.dir.c[1][0] = 0.0;
    m.dir.c[1][1] = mat->c[0][0];
    m.dir.c[1][2] = mat->c[0][1];
    
    m.dir.c[2][0] = 0.0;
    m.dir.c[2][1] = mat->c[1][0];
    m.dir.c[2][2] = mat->c[1][1];
    
    r2x2_t tam;
    r2x2_inv(mat, &(tam));
    r2_t psid;
    r2x2_map_row(disp, &(tam), &psid);
    ...
    m.inv.c[1][0] = 0.0;
    m.inv.c[1][1] = tam.c[0][0];
    m.inv.c[1][2] = tam.c[0][1];
    
    m.inv.c[2][0] = 0.0;
    m.inv.c[2][1] = tam.c[1][0];
    m.inv.c[2][2] = tam.c[1][1];
