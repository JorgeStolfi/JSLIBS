...
/* Last edited on 2024-09-17 19:37:57 by stolfi */
...
void test_hr2_pmap_sign__hr2_pmap_set_sign(bool_t verbose);
...
void test_hr2_pmap(bool_t verbose)
  {
    ...
    test_hr2_pmap_sign__hr2_pmap_set_sign(verbose);
...
void test_hr2_pmap_sign__hr2_pmap_set_sign(bool_t verbose)
  { if (verbose) { fprintf(stderr, "--- hr2_pmap_sign, hr2_pmap_set_sign ---\n"); }
