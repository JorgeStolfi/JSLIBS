...
/* Last edited on 2021-08-17 08:52:56 by stolfi */
...
rf3_t rf3_circumcenter(rf3_t *a, rf3_t *b, rf3_t *c);
  /* The center of the circle passing through the three points {a,b,c}. */

int32_t rf3_orient(rf3_t *a, rf3_t *b, rf3_t *c);
...
bool_t rf3_incircle (rf3_t *a, rf3_t *b, rf3_t *c, rf3_t *d);
